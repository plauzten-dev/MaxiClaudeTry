...
const exercises = [
  {
    ...
    fieldPlayers: 3, goalkeepers: 0, coreCompetency: 'Passspiel', difficulty: 'Anfänger', fieldSize: 'Klein',
  },
  {
    ...
    fieldPlayers: 6, goalkeepers: 0, coreCompetency: 'Ballbesitz', difficulty: 'Fortgeschritten', fieldSize: 'Klein',
  },
  {
    ...
    fieldPlayers: 2, goalkeepers: 1, coreCompetency: 'Torschuss', difficulty: 'Anfänger', fieldSize: 'Mittel',
  },
  {
    ...
    fieldPlayers: 6, goalkeepers: 0, coreCompetency: 'Pressing', difficulty: 'Fortgeschritten', fieldSize: 'Klein',
  },
  {
    name: 'Elfmeterschießen mit Variation',
    description: 'Spieler üben Elfmeter aus verschiedenen Positionen. Torwart bekommt Hinweis auf Ecke erst beim Anlauf.\n\nVarianten: Klassischer Elfmeter, Chipped Penalty, Nach vorherigem Dribbling.\n\nZiel: Nervenstärke, Technik und Torwartroutine.',
    fieldPlayers: 4, goalkeepers: 1, coreCompetency: 'Standardsituationen', difficulty: 'Anfänger', fieldSize: 'Klein',
  },
  {
    ...
    fieldPlayers: 2, goalkeepers: 0, coreCompetency: 'Zweikampf', difficulty: 'Anfänger', fieldSize: 'Klein',
  },
  {
    name: 'Gegenpressing nach Ballverlust',
    description: 'In einem Großfeld spielen zwei Teams (7v7). Nach jedem Ballverlust wird sofortiges Gegenpressing trainiert.\n\nZiel: Umschaltverhalten, Kondition und Teamkommunikation.',
    fieldPlayers: 14, goalkeepers: 2, coreCompetency: 'Pressing', difficulty: 'Experte', fieldSize: 'Groß',
  },
  {
    ...
    fieldPlayers: 7, goalkeepers: 1, coreCompetency: 'Torschuss', difficulty: 'Fortgeschritten', fieldSize: 'Mittel',
  },
  {
    name: 'Freistoßtraining aus 20 Metern',
    description: 'Spieler üben Freistöße aus verschiedenen Winkeln und Distanzen (18-25m). Mauer aus 2-3 Spielern wird aufgestellt.\n\nVarianten: Direkter Schuss, Flanke in den Strafraum, Kombination mit Ablage.',
    fieldPlayers: 5, goalkeepers: 1, coreCompetency: 'Standardsituationen', difficulty: 'Fortgeschritten', fieldSize: 'Mittel',
  },
  {
    ...
    fieldPlayers: 16, goalkeepers: 2, coreCompetency: 'Ballbesitz', difficulty: 'Experte', fieldSize: 'Groß',
  },
]
...
export async function GET() {
  try {
    ...
    if (count > 0) {
      return NextResponse.json({ message: `Datenbank bereits befüllt (${count} Übungen)` })
    }
    for (const ex of exercises) {
      await prisma.exercise.create({ data: ex })
    }
    return NextResponse.json({ message: `${exercises.length} Übungen erfolgreich hinzugefügt!` })
  } catch (error) {
